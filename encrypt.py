...
def final_encryption(path,message):
    ...
    messagebox.showinfo("Saved","Encryped file stored in C:/Users/User/Desktop/encrypted_images")
...
but0=Button(root,text="Select image",background="black",fg="white",font="TkFixedFont",command=browse)
but0.pack()
